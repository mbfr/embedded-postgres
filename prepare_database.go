...
type initDatabase func(credential *syscall.SysProcAttr, binaryExtractLocation, runtimePath, pgDataDir, username, password, locale string, logger *os.File) error
